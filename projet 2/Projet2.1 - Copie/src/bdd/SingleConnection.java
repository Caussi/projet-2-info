...
public class SingleConnection {
	...
	private SingleConnection(String serverName, String dbName, String login, String password) throws ClassNotFoundException, SQLException, NamingException{
		...
		mysqlDS.setDatabaseName("tp_jdbc");
		mysqlDS.setDescription("bd tp jbdc");

		Context ctx = new InitialContext();
		ctx.bind("jdbc/tp_jdbc", mysqlDS);

		MysqlDataSource ds = (MysqlDataSource)ctx.lookup("jdbc/tp_jdbc");
